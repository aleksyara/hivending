...
const UnifiedContactForm = ({ 
  ...
  const {
    ...
    defaultValues: {
      ...
      email: '',
      phone: '',
      inquiryType: 'I\'m interested in the new Vending Service',
      message: '',
      ...
      <form onSubmit={handleSubmit(onSubmit)} className={spacing}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
          ...
          <div>
            ...
            >
              <option value="I'm interested in the new Vending Service">I'm interested in the new Vending Service</option>
